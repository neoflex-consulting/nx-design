    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement(Text_1.Text, { view: "secondary", size: "s", lineHeight: "s", align: "center" },
            ...
            requirements && (react_1["default"].createElement(react_1["default"].Fragment, null,
                ...
                requirements))),
        react_1["default"].createElement(Button_1.Button, { className: cnDragNDropFieldContent('Button'), label: "\u0412\u044B\u0431\u0440\u0430\u0442\u044C " + fileText, iconLeft: IconAttach_1.IconAttach, view: "ghost", size: "s", onClick: openFileDialog })));
};
