...
var ERROR_FORMATTERS = {
    'file-invalid-type': function (_a) {
        var type = _a.type;
        return ['формат файла не подходит', type && "(" + type + ")"].filter(isNotNil).join(' ');
    },
    'file-too-large': function (_a) {
        var size = _a.size;
        return "\u0444\u0430\u0439\u043B \u0441\u043B\u0438\u0448\u043A\u043E\u043C \u0431\u043E\u043B\u044C\u0448\u043E\u0439 (\u043C\u0430\u043A\u0441\u0438\u043C\u0443\u043C " + formatFileSize(size) + ")";
    },
    'file-too-small': function (_a) {
        var size = _a.size;
        return "\u0444\u0430\u0439\u043B \u0441\u043B\u0438\u0448\u043A\u043E\u043C \u043C\u0430\u043B\u0435\u043D\u044C\u043A\u0438\u0439 (\u043C\u0438\u043D\u0438\u043C\u0443\u043C " + formatFileSize(size) + ")";
    }
};
var GENERAL_ERROR = 'не получилось добавить файл';
export var getErrorsList = function (fileRejections) {
    var e_1, _a, e_2, _b;
    var _c, _d;
    var errorsList = [];
    var tooManyFilesErrorsCount = 0;
    try {
        for (var fileRejections_1 = __values(fileRejections), fileRejections_1_1 = fileRejections_1.next(); !fileRejections_1_1.done; fileRejections_1_1 = fileRejections_1.next()) {
            var rejection = fileRejections_1_1.value;
            try {
                for (var _e = (e_2 = void 0, __values(rejection.errors)), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var error = _f.value;
