...
exports.HeaderButton = function (props) {
    ...
    return (react_1["default"].createElement(index_1.Button, tslib_1.__assign({}, otherProps, { className: exports.cnHeaderButton(null, [className]), size: "m", view: "clear", form: "round", onlyIcon: true })));
};
