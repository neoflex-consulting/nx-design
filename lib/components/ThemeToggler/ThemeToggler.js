...
exports.ThemeToggler = react_1["default"].forwardRef(function (props, componentRef) {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement(index_1.Button, tslib_1.__assign({}, otherProps, { ref: ref, iconLeft: getButtonIcon(), onClick: onButtonClick, onlyIcon: true, size: size, view: "clear" })),
