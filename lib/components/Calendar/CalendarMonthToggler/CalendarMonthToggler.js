...
exports.CalendarMonthToggler = function (props) {
    ...
    return (react_1["default"].createElement("div", tslib_1.__assign({}, otherProps, { className: exports.cnCalendarMonthToggler({ withPrevButton: Boolean(prevOnClick), withNextButton: Boolean(nextOnClick) }, [className]) }),
        prevOnClick && (react_1["default"].createElement(index_1.Button, { className: exports.cnCalendarMonthToggler('Button', { direction: 'prev' }), onClick: prevOnClick, iconLeft: IconForward_1.IconForward, size: "s", view: "clear", iconSize: "s" })),
        ...
        nextOnClick && (react_1["default"].createElement(index_1.Button, { className: exports.cnCalendarMonthToggler('Button', { direction: 'next' }), onClick: nextOnClick, iconLeft: IconForward_1.IconForward, size: "s", view: "clear", iconSize: "s" }))));
};
