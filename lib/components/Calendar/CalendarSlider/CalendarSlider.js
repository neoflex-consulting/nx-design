...
exports.CalendarSlider = function (props) {
    ...
    return (react_1["default"].createElement("div", tslib_1.__assign({}, otherProps, { className: exports.cnCalendarSlider(null, [className]) }),
        react_1["default"].createElement(index_1.Button, { className: exports.cnCalendarSlider('Button', { direction: 'prev' }), view: "ghost", iconLeft: IconForward_1.IconForward, onClick: handlePrev }),
        ...
        react_1["default"].createElement(index_1.Button, { className: exports.cnCalendarSlider('Button', { direction: 'next' }), view: "ghost", iconLeft: IconForward_1.IconForward, onClick: handleNext })));
};
