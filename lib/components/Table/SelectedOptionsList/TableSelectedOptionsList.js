...
exports.TableSelectedOptionsList = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: cnTableSelectedOptionsList() },
        ...
        react_1["default"].createElement(index_1.Button, { type: "button", onClick: onReset, title: "\u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C \u0432\u0441\u0435 \u0444\u0438\u043B\u044C\u0442\u0440\u044B", size: "xs", view: "clear", onlyIcon: true, iconLeft: IconClose_1.IconClose, className: cnTableSelectedOptionsList('Button') })));
};
