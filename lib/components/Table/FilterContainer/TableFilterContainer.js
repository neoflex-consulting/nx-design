...
exports.TableFilterContainer = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: cnTableFilterContainer(null, [className]) },
        ...
        react_1["default"].createElement("div", { className: cnTableFilterContainer('Buttons') },
            react_1["default"].createElement(index_1.Button, { label: cancelButtonLabel, size: "s", view: "ghost", onClick: onCancel }),
            react_1["default"].createElement(index_1.Button, { label: confirmButtonLabel, size: "s", view: "primary", onClick: onConfirm }))));
};
