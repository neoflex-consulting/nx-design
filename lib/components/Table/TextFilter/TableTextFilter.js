...
exports.TableTextFilter = function (_a) {
    ...
    return (react_1["default"].createElement(TableFilterContainer_1.TableFilterContainer, { title: title, onCancel: onCancel, onConfirm: confirmHandler },
        ...
        react_1["default"].createElement("div", { className: cnTextFilter('Controls') },
            react_1["default"].createElement(index_1.Button, { size: "m", form: "brick", label: "\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u0432\u0441\u0435", view: "clear", onClick: setAll, disabled: !filteredItems.length || isAllSelected }),
            react_1["default"].createElement(index_1.Button, { size: "m", form: "brick", label: "\u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C", view: "clear", onClick: resetHandler, disabled: !filteredItems.length })),
