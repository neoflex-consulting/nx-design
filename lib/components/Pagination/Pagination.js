...
exports.Pagination = react_1["default"].forwardRef(function (props, ref) {
    ...
    return ((!isEmpty && (react_1["default"].createElement("nav", tslib_1.__assign({ className: exports.cnPagination({ form: form, size: size, position: minified ? exports.paginationDefaultPosition : position }, [className]), ref: ref }, otherProps),
        (currPage > 1 || minified) && (react_1["default"].createElement("div", { className: exports.cnPagination('PrevPage') },
            react_1["default"].createElement(index_1.Button, { className: exports.cnPagination('ItemLeft', {
                    minified: minified,
                    show: currPage > 1
        ...
        type === exports.paginationDefaultType ? (react_1["default"].createElement("div", { className: exports.cnPagination('Pages') },
            isStartDots && (react_1["default"].createElement(index_1.Button, { className: exports.cnPagination('Item', { isActive: currPage === 1 }), style: { width: itemWidth }, label: "1", title: "1", view: "ghost", form: form, size: size, onClick: handleClick(1) })),
            ...
            pages.map(function (page) { return (react_1["default"].createElement(index_1.Button, { key: page, className: exports.cnPagination('Item', { isActive: currPage === page }), style: { width: itemWidth }, label: page, title: "" + page, view: "ghost", form: form, size: size, onClick: handleClick(page) })); }),
            ...
            isEndDots && (react_1["default"].createElement(index_1.Button, { className: exports.cnPagination('Item', { isActive: currPage === totalPages }), style: { width: itemWidth }, label: totalPages, title: "" + totalPages, view: "ghost", form: form, size: size, onClick: handleClick(totalPages) })))) : (react_1["default"].createElement("div", { className: exports.cnPagination('Pages') },
        ...
        (currPage < totalPages || minified) && (react_1["default"].createElement("div", { className: exports.cnPagination('NextPage') },
            react_1["default"].createElement(index_1.Button, { className: exports.cnPagination('ItemRight', {
                    minified: minified,
