...
exports.ResponsesDeleted = createResponses_1.createResponses({
    ...
    actions: (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement(index_1.Button, { label: "\u0412\u0435\u0440\u043D\u0443\u0442\u044C \u043D\u0430 \u043C\u0435\u0441\u0442\u043E", view: "ghost", style: { marginRight: 'var(--space-m)' } }),
        react_1["default"].createElement(index_1.Button, { label: "\u041E\u0442\u043B\u0438\u0447\u043D\u043E!", view: "ghost" })))
});
