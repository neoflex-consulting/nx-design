...
exports.TabsFitModeScrollWrapper = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: cnTabsFitModeScrollWrapper() },
        isScrollable && (react_1["default"].createElement(react_1["default"].Fragment, null, ['prev', 'next'].map(function (buttonTo) { return (react_1["default"].createElement(index_1.Button, { key: buttonTo, view: "clear", size: "xs", onlyIcon: true, disabled: buttonTo === 'prev'
