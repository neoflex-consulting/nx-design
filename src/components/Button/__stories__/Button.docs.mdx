...
<Button label="Комментировать" view="secondary" iconLeft={iconLeft} />
<Button label="Редактировать" view="secondary" iconRight={iconRight} onlyIcon />
```
...
<Button label="Настройки" view="ghost" iconLeft={iconLeft} />
<Button label="Фильтр" view="ghost" iconLeft={iconLeft_} onlyIcon />
```
...
<Button label="Скопировать" view="clear" iconLeft={iconLeft} />
<Button label="Добавить в Избранное" view="clear" iconLeft={iconLeft_} onlyIcon />
```
...
<Button label="Назад" view="link" iconLeft={iconLeft} />
<Button label="Сохранить" view="link" iconLeft={iconLeft_} onlyIcon />
```
...
<Button label="Продолжить" disabled iconRight={iconRight} />
<Button label="Добавить" disabled iconRight={iconRight_} onlyIcon />
```
...
Например: Отображение перевода через i18n. Добавление Link.
...
<Button
    ...
    label= {
      <NeoIcon className={'changeToDevelopButton'} icon={"play-c"} color={'white'} />
    }
/>
```
...
| [`iconLeft`](#кнопка-с-иконкой)  | `React.ReactNode`                                                                         | -                         | Иконка слева                                                                     |
| [`iconRight`](#кнопка-с-иконкой) | `React.ReactNode`                                                                         | -                         | Иконка справа                                                                    |
