...
| [`separateRows?`](#границы-между-строками-расширенные)           | `boolean`                                                                                                                    | `false`                                           | Отображение границ между строками расширенные                                                                         |
| [`nameResetAllFilters?`](#плейсхолдер-кнопка-сброить-все-фильтры)| `string`                                                                                                                     | `Сбросить все`                                    | Плейсхолдер на кнопке Сброить все фильтры                                                                             |
