...
import { ThemeToggler } from 'nx-design/ThemeToggler';
import { Wifi } from 'nx-design/Wifi';
import { DocRightClose } from 'nx-design/DocRightClose';
...
const Examle = () => {
  ...
  return (
    <ThemeToggler
      ...
      getItemIcon={(theme) => (theme === 'Default' ? Wifi : DocRightClose)}
