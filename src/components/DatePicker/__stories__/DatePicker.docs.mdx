...
- `type=date` или `type=date-range` — `format='yyyy-MM-dd'`
...
- `'date'` - Выбор дня, месяца и года `format='yyyy-MM-dd'`
- `'month'` - Выбор месяца и года `format='yyyy-MM'`
- `'year'` - Выбор только года `format='yyyy'`
...
<DatePicker label="Лейбл" labelPosition="bottom" />
<DatePicker label="Лейбл" labelPosition="right" />
```
...
| [`labelPosition?`](#лейбл)                                                 | `'top', 'left'`, 'bottom'`, 'right'`                                                                                                                                | `'top'`               | Положение лейбла относительно поля                                                                                     |
