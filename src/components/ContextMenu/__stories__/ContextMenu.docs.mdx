...
```tsx
import { ContextMenu } from 'nx-design/ContextMenu';
```
...
| [`theme?`](#цветовая-тема)                                     | `'primary', 'secondary'`                                                                                            | `'primary'`      | Цветовая тема контекстного меню                                                                                                                                              |
...
| [`getItemStatus?`](#статус-пунка-меню)                         | `(item: ITEM) => 'error'`<code>&#124;</code>`'warning'`<code>&#124;</code>`'success'`<code>&#124;</code>`undefined` | -                | Результат функции используется как статус пункта меню                                                                                                                        |
