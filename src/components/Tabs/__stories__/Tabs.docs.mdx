...
import { Tabs } from 'nx-design/Tabs';
...
import { Tabs } from 'nx-design/Tabs';
import { Image } from 'nx-design/Image';
import { Bell } from 'nx-design/Bell';
import { Camera } from 'nx-design/Camera';
...
Свойство `onClose` отвечает за действия при закрытии табов (нажатие на кнопку закрытия)

Для включения на табе кнопки закрытия, необходимо указать свойство `closeIcon === true`.
Это сделано для того, чтобы главные табы всегда открытыми, без права на закрытие.
А у второстепенных табов была возможность скрыться от пользователя.
...
```tsx
import React, { useState } from 'react';
import { Tabs, cnTabsTab } from 'nx-design/Tabs';
...
import { Badge, BadgePropStatus } from 'nx-design/Badge';
import { cnTabsTab, Tabs } from 'nx-design/Tabs';
...
| [`view?`](#рамка)                              | `'bordered', 'clear', 'stroke'`                  | `'bordered'` | Внешний вид компонента (с рамкой или без)                                                                                                                                            |
...
| `onClose`                                      | `OnClose`                                        | -            | Действие при закрытии элемента                                                                                                                                                       |
