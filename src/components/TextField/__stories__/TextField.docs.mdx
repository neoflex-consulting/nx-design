...
```tsx
<TextField leftSide={Gift} rightSide="карат" />
```
...
<TextField status="error" placeholder="Статус error" caption="Это подпись" />
...
<TextField status="error" placeholder="Статус error" />
...
| [`status?`](#статус-поля)                  | `'', 'error', 'success', 'warning'`                                                                                                                                  | `' '`        | Тип поля                                                                                                  |
