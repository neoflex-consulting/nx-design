...
import { ComboboxExampleChangeIcon } from './examples/ComboboxExampleChangeIcon/ComboboxExampleChangeIcon';
...
Для изменения иконки необходимо воспользоваться свойством `iconRight`
> По-умолчанию `iconRight = <IconCaretDown size="xs"/>`

Если вы используете иконку, поворот которой не предусмотрен при нажатии, то, необходимо воспользоваться свойством `iconUp`
> По-умолчанию `iconUp = true`

<ComboboxExampleChangeIcon/>
...
| [`iconRight?`](#выбор-иконки)                             | `React.ReactNode, React.FC<IconProps>`                 | `<IconCaretDown size="xs"/>`                                  | Иконка справа                                                          |
| [`iconUp?`](#поворот-иконки)                              | `boolean`                                              | `true`                                                        | Включение/выключение поворота иконки при нажатии                       |
