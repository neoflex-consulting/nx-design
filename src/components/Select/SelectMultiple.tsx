...
function SelectMultipleRender<ITEM = DefaultItem, GROUP = DefaultGroup>(
  ...
  const {
    ...
    ...restProps
  } = usePropsHandler('SelectMultiple', withDefaultGetters(props), controlRef);
...
export const SelectMultiple = forwardRef(SelectMultipleRender) as SelectComponent;
