...
Напирмер, `withTooltip` можно добавить к обычному тексту (заданному в компоненте `Typography`).
...
Свойство `size` определяет ширину тултипа. Варианты: `'s'`, `'m'`, `'l'`, `'window'`, по умолчанию `'m'`.
...
| ------------------------ | ------------------------- | ----------------- | --------------------------------------------------------------------------------------------------------------------- |
| [`size`](#ширина)        | `'s', 'm', 'l', 'window'` | '`m`'             | Максимальная ширина тултипа                                                                                           |
